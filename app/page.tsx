...
const worries = [
	{
		id: "note",
		label: "終活ノートを作りたい",
		desc: "エンディングノートの書き方がわからない",
	},
	{
		id: "inherit",
		label: "相続のことが心配",
		desc: "遺産・遺言・相続税の手続きが不安",
	},
	{
		id: "money",
		label: "老後のお金が不安",
		desc: "生活費・介護費・資産管理を整理したい",
	},
	{
		id: "digital",
		label: "デジタル遺品を整理したい",
		desc: "SNS・ネット口座などのデータを残したくない",
	},
];
	...
	return (
		<section className="py-16 px-6">
			<div className="max-w-3xl mx-auto">
				<p className="text-xs font-medium text-green-400 text-center mb-2">
					3秒でわかる
				</p>
				<h2 className="text-2xl font-bold text-center mb-2 section-heading">
					今、一番気になっていることは？
				</h2>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					{worries.map((w) => (
						...
						>
							<p
								className={`font-bold text-base mb-1 ${selected === w.id ? "text-green-300" : "text-gray-200"}`}
							>
								{selected === w.id && (
									<svg
										viewBox="0 0 24 24"
										className="w-4 h-4 fill-green-500 inline-block mr-1"
										aria-hidden="true"
									>
...
export default function ShukatsuLP() {
	...
	return (
		<main
			...
			style={{
				background:
					"radial-gradient(ellipse at 20% 50%, rgba(16, 185, 129, 0.12) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(52, 211, 153, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, rgba(99, 179, 237, 0.08) 0%, transparent 50%), #0F0F1A",
			}}
		>
			{/* Floating particles */}
				...
				{[
					...
					<div
						...
						style={{
							...
							left: p.l,
							top: p.t,
							background: `rgba(52, 211, 153, ${p.op})`,
			...
			<nav
				className="border-b border-white/10 px-6 py-4 sticky top-0 z-40"
				style={{
				...
				<div className="max-w-5xl mx-auto flex items-center justify-between">
					...
					<Link
						...
						style={{
							...
							boxShadow:
								"0 0 15px rgba(16, 185, 129, 0.3), 0 4px 10px rgba(0,0,0,0.2)",
						}}
					>
						無料で相談する
					</Link>
			...
			<section className="max-w-4xl mx-auto px-6 py-20 text-center relative z-10">
				<div
					className="inline-block text-emerald-300 text-xs font-medium px-4 py-1.5 rounded-full mb-6"
					style={{
				...
				<h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
					<span className="text-white">終活のことを</span>
					<br />
					<span
						style={{
							background:
								"linear-gradient(135deg, #F1F5F9 0%, #10B981 50%, #059669 100%)",
				...
				<Link
					...
					style={{
						background: "linear-gradient(135deg, #10B981 0%, #059669 100%)",
						boxShadow:
							"0 0 25px rgba(16, 185, 129, 0.35), 0 4px 15px rgba(0,0,0,0.3)",
					}}
				>
					無料でAIに相談する →
				</Link>
			...
			<section className="py-16 relative z-10">
				<div className="max-w-4xl mx-auto px-6">
					<h2 className="text-2xl font-bold text-center mb-10 section-heading">
						こんなお悩みはありませんか？
					</h2>
			...
			<section className="py-12 px-6 max-w-3xl mx-auto relative z-10">
				<h2 className="text-xl font-bold text-center mb-6 section-heading">
					こんな経験ありませんか？
				</h2>
				<div className="space-y-4">
					{[
						{
							icon: "1",
							text: "終活を始めなきゃと思いつつ、何から手をつければいいかわからず後回しにしてしまう...",
						},
						{
							icon: "2",
							text: "家族への負担を少なくしたいのに、相続や遺言の手続きが複雑すぎて一人では無理...",
						},
						{
							icon: "3",
							text: "専門家に相談するほどでもないかな...と気軽に相談できる場所がない...",
						},
					].map((item, i) => (
						<div
							key={i}
				...
				<div
					className="mt-6 text-white rounded-2xl p-5 text-center"
					style={{
						background:
				...
				>
					...
					<p className="text-emerald-100 text-sm">
						気軽に・無料で・24時間。AIがあなたのペースで丁寧にサポートします。
					</p>
				</div>
			</section>
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-6">
						{[
							{
								name: "Yさん（65歳・主婦）",
								text: "エンディングノートの書き方がわからず後回しにしていました。AIが質問に答えていく形式なので、気づいたら30分で基本的な内容が完成していました。",
							},
							{
								name: "Kさん（58歳・会社員）",
								text: "相続や遺言について専門家に相談するのは敷居が高かった。AIに状況を入力したら分かりやすく説明してくれて、何を準備すればいいか整理できました。",
							},
							{
								name: "Mさん（70歳・自営業）",
								text: "デジタル遺品の整理について子供に伝えたかった。AIが整理したリストを印刷して渡したら、子供たちも安心してくれました。",
							},
						].map((t) => (
							<div
								key={t.name}
			...
			<section className="py-16 relative z-10">
				<div className="max-w-4xl mx-auto px-6 text-center">
					<h2 className="text-2xl font-bold mb-6 section-heading">料金プラン</h2>

					{/* 年額/月額トグルスイッチ（デフォルト: 年額。「2ヶ月無料」のゼロ価格効果でCVR最大化） */}
					<div className="flex items-center justify-center gap-4 mb-8">
						<span
							className={`text-sm font-medium transition-colors ${!isAnnual ? "text-white" : "text-white/40"}`}
						>
							月額
						</span>
						<button
								...
								<div
									...
									style={{
										...
										boxShadow: plan.highlight
											? "0 0 30px rgba(16, 185, 129, 0.15), 0 8px 32px rgba(0,0,0,0.2)"
								...
								>
									{plan.highlight && (
										<div className="absolute -top-3 left-1/2 -translate-x-1/2 flex items-center gap-1">
											<span
												className="text-xs text-white px-3 py-0.5 rounded-full font-bold"
												style={{
													background:
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
							{[
								...
								>
									{plan.highlight && (
										<div
											className="absolute -top-3 left-1/2 -translate-x-1/2 text-xs text-white px-3 py-0.5 rounded-full font-bold"
											style={{
												background: "linear-gradient(135deg, #10B981, #059669)",
											}}
										>
			...
			>
				<div className="max-w-3xl mx-auto">
					...
					{[
						{
							q: "無料で使えますか？",
							a: "基本機能は無料で3回までご利用いただけます。クレジットカードの登録も不要です。",
						},
						{
							q: "個人情報は安全ですか？",
							a: "入力された情報はAI分析のみに使用し、第三者への提供は行いません。SSL暗号化通信で安全に保護されています。",
						},
						{
							q: "AIの回答は法的に有効ですか？",
							a: "本サービスは情報提供を目的としており、法律・税務・医療の専門的アドバイスではありません。具体的な手続きは必ず専門家にご相談ください。",
						},
						{
							q: "エンディングノートの作成にどのくらい時間がかかりますか？",
							a: "AIの質問に答えていくだけで、30分程度で基本的な内容が完成します。ご自身のペースで進めていただけます。",
						},
					].map(({ q, a }) => (
						<details
							key={q}
				...
				items={[
					{
						question: "無料で使えますか？",
						answer:
							"基本機能は無料で3回までご利用いただけます。クレジットカードの登録も不要です。",
					},
					{
						question: "個人情報は安全ですか？",
						answer:
							"入力された情報はAI分析のみに使用し、第三者への提供は行いません。SSL暗号化通信で安全に保護されています。",
					},
					{
						question: "AIの回答は法的に有効ですか？",
						answer:
							"本サービスは情報提供を目的としており、法律・税務・医療の専門的アドバイスではありません。具体的な手続きは必ず専門家にご相談ください。",
					},
					{
						question:
							"エンディングノートの作成にどのくらい時間がかかりますか？",
						answer:
							"AIの質問に答えていくだけで、30分程度で基本的な内容が完成します。ご自身のペースで進めていただけます。",
					},
					{
						question: "デジタル遺品の整理は何から始めればいいですか？",
						answer:
							"SNSアカウント・ネット銀行・サブスクリプションサービスのリスト化から始めましょう。AI終活サポートがサービスごとの対処方法（解約・引き継ぎ・削除申請）を案内します。",
					},
				]}
			/>
			<script
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						operatingSystem: "Web",
						description:
							"エンディングノート作成・相続手続き案内・デジタル遺品整理を24時間AIがサポート。50代・60代・70代向けの終活相談Webサービス。無料3回から利用可能。",
			...
			<section className="py-8 px-4 text-center">
				...
				<div className="mt-3 flex justify-center">
					<XShareButton
						text="AI終活サポートを使ってみた！エンディングノート・相続・デジタル遺品整理をAIがサポート。"
						url="https://shukatsu-ai.vercel.app"
						hashtags={["終活AI", "終活"]}
					/>
				</div>
			...
			<footer className="border-t border-white/10 py-6 text-center text-xs text-gray-400 space-y-2 relative z-10">
				<p>
					AI終活サポート © 2026
					※本サービスは情報提供を目的としており、法律・税務・医療の専門的アドバイスではありません。
				</p>
				<p>
					<Link
						href="/legal"
						aria-label="特定商取引法に基づく表記を確認する"
