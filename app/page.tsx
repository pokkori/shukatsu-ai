...
export default function ShukatsuLP() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
      <nav className="border-b border-white/10 px-6 py-4 backdrop-blur-sm bg-white/5" aria-label="メインナビゲーション">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
          終活のことを<br />
          <span className="text-green-400">AIに相談</span>してみませんか
        </h1>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="backdrop-blur-sm grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            {[
              ...
              <div key={p} className="flex gap-3 backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-4">
      ...
      <section className="py-12 px-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex items-center gap-4 backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-4">
        ...
        <div className="mt-6 backdrop-blur-sm bg-green-600/80 border border-green-400/30 text-white rounded-2xl p-5 text-center shadow-lg">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="backdrop-blur-sm grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={t.name} className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl p-6 shadow-lg">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="backdrop-blur-sm grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={plan.name}
                className={`backdrop-blur-sm rounded-2xl border p-6 relative ${plan.highlight ? "border-green-400 bg-white/10 shadow-lg shadow-green-900/30" : "border-white/10 bg-white/5"}`}
              >
                {plan.highlight && (
      ...
      <section className="backdrop-blur-sm bg-green-600/80 border-t border-green-400/30 py-16 text-center">
      ...
      <footer className="border-t border-white/10 py-6 text-center text-xs text-gray-400 space-y-2">
