...
export async function POST(req: NextRequest) {
  ...
  const inheritanceCaution = ageNum >= 60 ? "相続税の基礎控除（3,000万円＋法定相続人×600万円）を念頭に" : "";
...
（相談内容を踏まえた、具体的なアクション3つ。「〇〇する」と断言形式で。それぞれに「なぜ今やる必要があるか」の理由も添えて。）

---

## 📝 エンディングノート記載必須項目

以下のカテゴリ別に、この方の状況で特に重要な項目をリストアップ：
